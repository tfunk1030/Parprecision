...
export class EnvironmentalSystem {
    ...
    // Ball construction sensitivity map
    private readonly CONSTRUCTION_SENSITIVITY: Record<string, number> = {
        '2-piece': 0.8,
        '3-piece': 1.0,
        '4-piece': 1.2,
        '5-piece': 1.4
    ...
    private calculateBallTempEffects(
        ...
        const sensitivity = this.CONSTRUCTION_SENSITIVITY[ballProperties.construction] || 1.0;
