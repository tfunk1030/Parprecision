...
import { Environment, BallProperties, EnvironmentalConditions } from './types';
...
describe('SimplifiedShotModel', () => {
    ...
    describe('calculateAdjustedDistance', () => {
        ...
        test('high altitude should increase distance', () => {
            const env: EnvironmentalConditions = {
                ...
                windSpeed: 0,
                windDirection: 0,
                density: 1.225 * 0.942 // Adjusted for altitude
            };
    ...
    test('combined environmental and wind effects', () => {
        const env: EnvironmentalConditions = {
            ...
            windSpeed: 0,
            windDirection: 0,
            density: 1.225 * 0.971 // Adjusted for altitude
        };
