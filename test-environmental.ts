...
import { EnvironmentalCalculator, EnvironmentalConditions } from '../perfect-ui/parprecisionUI/lib/environmental-calculations';

function testConditions(conditions: EnvironmentalConditions) {
  console.log('\n=== Testing Conditions ===');
...
// Run with: ts-node test-environmental.ts