...
export default function ShotCalculatorPage() {
  ...
  const calculateAdjustments = useCallback(() => {
    ...
    // Log detailed weather conditions for debugging
    ...
    // At higher altitudes, air is thinner so ball travels further
    // Use exponential relationship based on altitude 
    const altitudeEffect = (Math.exp(altitudeInMeters / 10000) - 1) * targetYardage * 0.1
